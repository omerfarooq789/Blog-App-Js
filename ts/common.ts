import { BlogType } from "./index.js";

const logoutBtn = document.querySelector("#signOut-btn") as HTMLButtonElement;
...
export const myPosts = () => {
  const myposts = document.querySelector("#my-posts") as HTMLAnchorElement;
...
export const sessionCheck = () => {
  const session = localStorage.getItem("user-id");
  if (session) {
    const navList = document.querySelector("#nav-hidden") as HTMLUListElement;
